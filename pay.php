    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav navbar-right">
                    <li id = "cart">
                        <a class="navbar-brand" href="cartshow.php"><span class="glyphicon glyphicon-shopping-cart"></span> Bookings</a>
                    </li>           
...
<div class="jumbotron text-center">
        <h1>Jet.Set.Go</h1> 
        <p>Fly Your Dreams. Fly with Us</p> 
</div>
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      ...
      <div><img src="credit-cards-icons.png" alt="smile" id="smile">
      </div>
